//
//  RemoteMoviesRepositoryImplTests.swift
//  Movies
//
...
final class RemoteMoviesRepositoryImplTests: XCTestCase {
    
    // MARK: - Private Typealias
    
    private typealias SUT = RemoteMoviesRepositoryImpl
    ...
    func test_fetch_shouldReturnValues() {
        ...
        sut.fetch(page: 1).sink {
            ...
            XCTAssertNotNil($0)
            XCTAssertEqual($0.results.count, 3)
        }.store(in: &tasks)
